...
from alpesonline.config import init_db
...
def app():
    ...
    with app.app_context():
        ...
        from alpesonline.config import db
...
def test_reservar_vuelo(client):
    rv = client.post('/drivers/reserva', data=json.dumps(reserva_correcta()), content_type='application/json')
